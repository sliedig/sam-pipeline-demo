pipeline {
  ...
  environment {
    ...
    TESTING_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::490195310065:role/aws-sam-cli-managed-dev-pipe-PipelineExecutionRole-1VRW6S49TBKO7'
    TESTING_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::490195310065:role/aws-sam-cli-managed-dev-p-CloudFormationExecutionR-1S163GV73C44N'
    TESTING_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-dev-pipeline-artifactsbucket-4leoc9szulx0'
    ...
    PROD_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::490195310065:role/aws-sam-cli-managed-prod-pip-PipelineExecutionRole-1UXX1V9VDOUHO'
    PROD_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::490195310065:role/aws-sam-cli-managed-prod-CloudFormationExecutionR-TXWZPU0AUSUF'
    PROD_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-prod-pipeline-artifactsbucket-h2qg5q7ybmcq'
    // If there are functions with "Image" PackageType in your template,
